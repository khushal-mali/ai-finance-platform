...
const accessTokenSignOptoins: SignOptsAndSecret = {
...
export const signJwtToken = (
  ...
  const isAccessToken = !options || options === accessTokenSignOptoins;

  const { secret, ...opts } = options || accessTokenSignOptoins;
